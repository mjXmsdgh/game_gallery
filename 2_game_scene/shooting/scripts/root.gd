...
# シーンをプリロード
const StartScene: PackedScene = preload("res://2_game_scene/shooting/scenes/1_start.tscn")
const MainScene: PackedScene = preload("res://2_game_scene/shooting/scenes/2_main.tscn")
const EndScene: PackedScene = preload("res://2_game_scene/shooting/scenes/3_end.tscn")
